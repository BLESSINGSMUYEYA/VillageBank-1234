...
import { ArrowRight, ChevronRight, Speaker } from 'lucide-react';
...
const banners: BannerSlide[] = [
    {
        ...
        image: '/banners/education.jpg', // We might need to use a placeholder or consistent gradient if image is missing
    ...
    },
    {
        ...
        ctaLink: '/groups',
        theme: 'light', // Maybe light theme for variety
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className={cn(
                            ...
                            style={{
                                // Using a vibrant gradient fallback since we might not have the images yet
                                background: currentSlide.id === '1'
