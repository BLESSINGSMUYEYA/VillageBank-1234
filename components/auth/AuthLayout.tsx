...
export function AuthLayout({
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
            ...
            {/* Form Side (Right) */}
            <div className="flex flex-col justify-center items-center p-6 sm:p-12 relative bg-slate-50 dark:bg-background selection:bg-emerald-500/30 overflow-y-auto">
                {/* Ambient Background */}
