      ...
      <div className="relative z-10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-12 bg-emerald-50 dark:bg-emerald-900/10 rounded-2xl p-8 text-center">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">{t('help.need_help_title')}</h2>
            <p className="text-slate-600 dark:text-slate-400 mb-6 font-bold">
              {t('help.need_help_desc')}
            </p>
            <div className="inline-flex flex-col sm:flex-row gap-4 p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm w-full sm:w-auto">
              <div className="text-left px-4 pb-4 sm:pb-0 sm:border-r border-b sm:border-b-0 border-slate-200 dark:border-slate-700">
                <div className="text-xs text-slate-500 uppercase font-semibold">{t('help.email_support')}</div>
              ...
              <div className="text-left px-4 pt-2 sm:pt-0">
                <div className="text-xs text-slate-500 uppercase font-semibold">{t('help.call_us')}</div>
